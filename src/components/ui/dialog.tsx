  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'rounded-2xl border border-slate-800 bg-slate-900 shadow-2xl shadow-black/40',
        'p-6 outline-none',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          ...
          'focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 focus:ring-offset-slate-900',
