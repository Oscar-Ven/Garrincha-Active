...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center justify-between rounded-md border border-slate-700 bg-slate-800 px-3 py-2 text-sm text-slate-100',
      'placeholder:text-slate-500',
      'ring-offset-slate-900 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2',
